...
import 'DoctorsListScreen.dart'; // Import pour accéder à la classe Doctor
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        icon: Icon(Icons.calendar_today_outlined, color: Colors.grey[600]),
                        onPressed: () {},
                      ),
                      IconButton(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: [12, 13, 14, 15, 16, 17, 18].map((day) {
